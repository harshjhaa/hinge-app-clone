...
type DateOfBirthScreenNavProp = NativeStackNavigationProp<
  RootStackParamList,
  'Birth'
>;

const DateOfBirthScreen = () => {
  const [password, setDateOfBirth] = useState<string>('');

  const navigation = useNavigation<DateOfBirthScreenNavProp>();
    ...
    <SafeAreaView style={styles.passwordScreenContainer}>
      <View style={styles.contentWrapper}>
        ...
        <View style={styles.formWrapper}>
          ...
          >
            DateOfBirth should be at least 8 characters long and contain a mix
